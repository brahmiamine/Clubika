...
const PUBLIC_PREFIXES = ['/login', '/inscription/', '/mot-de-passe-oublie', '/droits-sans-compte', '/reinitialiser/', '/plateforme', '/partage/', '/exercice-des-droits', '/mentions-legales', '/confidentialite', '/cgu', '/confirmer-email/'];
// "/" est la landing page publique (app/page.tsx) : comparée en exact, pas en préfixe,
// pour ne pas rendre publiques toutes les routes.
const PUBLIC_EXACT_PATHS = ['/', '/inscription'];
