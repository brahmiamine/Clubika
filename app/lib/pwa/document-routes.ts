const PRODUCT_PREFIXES = ['/login', '/mot-de-passe-oublie', '/reinitialiser', '/plateforme', '/inscription', '/droits-sans-compte', '/exercice-des-droits', '/mentions-legales', '/confidentialite', '/cgu', '/confirmer-email'];
