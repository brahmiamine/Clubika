...
- `lru-cache@10.4.3` — https://github.com/isaacs/node-lru-cache#readme
- `lru-cache@5.1.1` — https://github.com/isaacs/node-lru-cache#readme
- `lucide-react@0.562.0` — https://lucide.dev
...
- `@babel/code-frame@7.28.6` — https://babel.dev/docs/en/next/babel-code-frame
...
- `which-typed-array@1.1.20` — https://github.com/inspect-js/which-typed-array#readme
